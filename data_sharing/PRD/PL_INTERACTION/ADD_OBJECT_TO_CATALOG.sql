call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_BRIDGE_CNPS_SURVEY',			-- SOURCE_OBJECT
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CALLBACK_OWNER',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CALLBACK_PRIORITY',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CALLBACK_ROOT_CAUSE',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CALLBACK_STATUS',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CALLBACK_TEAM',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_CONSUMER_PROGRAM',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_SEGMENT',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_SENTIMENT',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_SURVEY',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_SURVEY_CHANNEL',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_SURVEY_RESPONSE',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_TOPIC_TAXONOMY',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.DIM_CNPS_TOUCHPOINT',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.FACT_CNPS_CALLBACK',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
...
call DB_FRAMEWORK.UTILS.SP_ADD_OBJECT_TO_CATALOG(
	'DB_CONS_PL_PRD.PL_INTERACTION.FACT_CNPS_RESPONSE_TOPIC',			-- SOURCE_OBJECT
	'PRESENTATION',                             						-- OBJECT_DATA_LAYER
	'INTERNAL',                             							-- OBJECT_DATA_CLASSIFICATION
	'NO',                                       						-- OBJECT_HAS_PERSONAL_DATA
	'Evgeniy.Gussman@pmi.com',                       		            -- DATA_OWNER
